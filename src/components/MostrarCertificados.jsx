...
function MostrarCertificados({ constancia }) {
        ...
        <div className="mx-6 flex justify-center mb-4">
            ...
            >
                ...
                <div className="flex justify-center mt-2 ">
                    <Link to={constancia.url} target="_blank" className=" border border-gray-500 shadow-lg text rounded-md px-2 py-1 hover:bg-[#463eed] hover:text-white">
                        {"Version Web"}
                    </Link>
                </div>
